...
const Navbar = () => {
    ...
    return (
        <>
            <div className={`bg-black text-white py-3 px-4 flex justify-between items-center flex-wrap sticky md:fixed w-full z-50 bg-opacity-50 backdrop-blur-lg ${roboto.className}`}>
                <Link className="" href={`/`}>
                ...
                {/* Sponsor Button */}
                <Link href="mailto:hacknovate@abesit.edu.in" className='text-center mx-auto mt-2 md:mx-0'>
                    <button className="relative inline-flex h-8 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#65B4D4_0%,#ABEDAB_50%,#FFA357_100%)]" />
